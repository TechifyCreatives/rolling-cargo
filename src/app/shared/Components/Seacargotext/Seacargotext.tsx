    ...
    <div className="flex flex-col items-center justify-center my-10 bg-light-blue-100 px-2">
      <div className="w-full bg-white p-8">
        ...
        <p className="text-gray-700 text-center">
          ...
          https://www.high-endrolex.com/36 From full Container Loads (FCL) &
          ...
          customs clearance, and tariff classification. This is all operated by
          our dedicated team of expert freight specialists. They handle all the
