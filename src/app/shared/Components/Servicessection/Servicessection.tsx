            ...
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 lg:p-12">
              ...
              <div className="mb-6">
                <p className="text-sm md:text-base text-gray-600 leading-relaxed">
                  Discover shipping and logistics service options from Rolling
                  Cargo.
                </p>
              </div>
              ...
              <div className="bg-indigo-50 rounded-lg p-4 md:p-8 shadow-inner">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                    <IconItem icon={<Plane />} text="Air Freight" />
                    <IconItem icon={<Ship />} text="Sea Freight" />
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                    <IconItem icon={<ShoppingBag />} text="Online Shopping" />
                    <IconItem icon={<FileCheck />} text="Custom Clearance" />
                  </div>
                </div>
              </div>
