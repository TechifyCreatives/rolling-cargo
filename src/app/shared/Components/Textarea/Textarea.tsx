...
const Textarea = () => {
  return (
    <div className="flex flex-col items-center justify-center h-[400px] bg-light-blue-100 px-2">
      <div className="max-w-2xl w-full bg-white p-8">
        <h1 className="text-4xl font-bold mb-4 text-center">Our Solutions</h1>
        <hr className="border-t-4 border-gray-300 rounded-full w-3/4 mx-auto mb-6" />
