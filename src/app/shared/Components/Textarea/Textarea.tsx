...
const Textarea = () => {
  return (
    <div className="flex flex-col my-20 items-center justify-center h-[400px] bg-light-blue-100 px-2">
      <div className="w-full bg-white p-8">
        <h1 className="text-4xl font-bold mb-4 text-center">Our Solutions</h1>
        <hr className="border-t-4 border-[#640e0e] rounded-full w-1/4 mx-auto mb-6" />
